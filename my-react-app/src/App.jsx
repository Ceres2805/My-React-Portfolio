        ...
        <div id="home">
            ...
            <section id="projects" className='projects'>
                ...
                <div className="projects-container">
                    {[
                        { title: "ML Algorithms from scratch", description: "Implementation of various machine learning algorithms from scratch", imageUrl: "src/assets/ml_from_scratch.jpg", projectUrl: "https://example.com" },
                        { title: "Pathfinding Algorithm Visualizer", description: "A Unity 3D Project to visualize various pathfinding algorithms", imageUrl: "src/assets/algo_viz.gif", projectUrl: "https://example.com" },
                        { title: "Quantum Squares", description: "A two-player web based game developed using HTML, CSS, and JavaScript", imageUrl: "src/assets/quantum_sq.gif", projectUrl: "https://example.com" }
                    ].map((project, index) => (
                ...
                <div className="projects-container">
                    {[
                        { title: "Arduino based Battery Monitor", description: "A compact PCB design to monitor battery voltage using Arduino", imageUrl: "src/assets/pcb.png", projectUrl: "https://example.com" },
                        { title: "Satellite Attitude Control System", description: "A MATLAB simulation to control the attitude of a satellite", imageUrl: "src/assets/sat_control.jpg", projectUrl: "https://example.com" },
                        { title: "AM Radio Communication System Simulation", description: "An LTSpice simulation of an AM radio communication system", imageUrl: "src/assets/Graph.png", projectUrl: "https://example.com" },
                    ].map((project, index) => (
                        <ProjectCard key={index} {...project} />
                    ))}
                </div>
